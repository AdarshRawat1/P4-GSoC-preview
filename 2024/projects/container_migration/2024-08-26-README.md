...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="https://github.com/user-attachments/assets/b6b05204-0ce8-4edf-95a9-83560b572e74">
  <source media="(prefers-color-scheme: light)" srcset="https://github.com/user-attachments/assets/5de993e9-7130-4977-a6d9-dae1ddedbb6d">
  <img alt="Shows a graph of nodes and switches to demostrate a simple load balancing solution." src="https://github.com/user-attachments/assets/58be9215-bbb1-445a-8551-1af4da87f0a7" width="500">
</picture>
...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="https://github.com/user-attachments/assets/638d6095-5ea7-4d2f-89ce-79655b9b748a">
  <source media="(prefers-color-scheme: light)" srcset="https://github.com/user-attachments/assets/27f7005e-705d-4c4c-8203-4675a377aa7c">
  <img alt="Shows a flow chart of interaction between the user script, controller and BMv2 switch." src="https://github.com/user-attachments/assets/27f7005e-705d-4c4c-8203-4675a377aa7c" width="700">
</picture>
...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="https://github.com/user-attachments/assets/e688d748-41a4-4db7-b858-7ef805997a57">
  <source media="(prefers-color-scheme: light)" srcset="https://github.com/user-attachments/assets/cdb081e1-2fe3-47d4-9347-b452af09c2ce">
  <img alt="Shows how a container (h1) is connected to its network (h1-net) via a veth pair, and how that network is connected to the switch s1 via the network bridge h1-br." src="https://github.com/user-attachments/assets/cdb081e1-2fe3-47d4-9347-b452af09c2ce" width="400">
</picture>
...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="https://github.com/user-attachments/assets/63147caf-abd0-4f05-b148-e8b0ae2c125b">
  <source media="(prefers-color-scheme: light)" srcset="https://github.com/user-attachments/assets/8d4ebdaf-546f-4c95-be88-5a8b9ce3ac72">
  <img alt="Shows how hosts h1-h4 are connected to their respective networks and how the container networks are connected to the switch s1." src="https://github.com/user-attachments/assets/8d4ebdaf-546f-4c95-be88-5a8b9ce3ac72" width="400">
</picture>
...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="https://github.com/user-attachments/assets/831b57ab-0cf1-4870-bbb0-d3050c336371">
  <source media="(prefers-color-scheme: light)" srcset="https://github.com/user-attachments/assets/8ebafe54-14de-4ad2-a1fc-8515609b0d08">
  <img alt="Shows the architecture of the Redis migration example, with BE, FE and producer running on h1, and Redis DB on h2, and an arrow showcasing how Redis DB should be migrated to h3." src="https://github.com/user-attachments/assets/8ebafe54-14de-4ad2-a1fc-8515609b0d08" width="500">
</picture>
